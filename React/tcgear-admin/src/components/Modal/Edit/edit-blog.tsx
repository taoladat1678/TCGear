...
interface EditBlogProps {
  ...
  post: EditBlogPost;
  onClose: () => void;
  onSubmit: (updatedPost: EditBlogPost) => void;
}

const EditBlog: React.FC<EditBlogProps> = ({ isOpen, post, onClose, onSubmit }) => {
  const [formData, setFormData] = React.useState<EditBlogPost>(post);
      ...
      <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-secondary rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full relative z-[10000]">
          <div className="px-6 py-4 border-b border-primary/20 flex justify-between items-center">
            <h3 className="text-lg font-semibold text-accent font-orbitron">Chỉnh Sửa Bài Viết</h3>
