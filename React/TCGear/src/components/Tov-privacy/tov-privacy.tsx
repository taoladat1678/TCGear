    ...
    <>
      ...
      <section className="relative h-[80vh] flex items-center justify-center">
        ...
        <div
          ...
          data-aos="fade-up"
        >
          <h1 className="text-white text-4xl md:text-6xl font-bold mb-6 font-orbitron">
            ĐIỀU KHOẢN & BẢO MẬT
          </h1>
          <p className="text-white text-xl mb-8 font-open-sans">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="policy-container">
          ...
          {/* Terms of Use */}
          <div className="policy-section" data-aos="fade-up">
            <h2 className="policy-title">ĐIỀU KHOẢN SỬ DỤNG</h2>

            <h3 className="policy-subtitle">1. Chấp nhận Điều khoản</h3>
            <p className="policy-text">
            ...
            <h3 className="policy-subtitle">2. Giấy phép sử dụng</h3>
            <p className="policy-text">
            ...
            <h3 className="policy-subtitle">3. Tài khoản người dùng</h3>
            <p className="policy-text">
            ...
            <h3 className="policy-subtitle">4. Mua hàng và Thanh toán</h3>
            <p className="policy-text">
            ...
            <h3 className="policy-subtitle">5. Sở hữu trí tuệ</h3>
            <p className="policy-text">
          ...
          {/* Privacy Policy */}
          <div className="policy-section" data-aos="fade-up">
            <h2 className="policy-title">CHÍNH SÁCH BẢO MẬT</h2>

            <h3 className="policy-subtitle">1. Thông tin chúng tôi thu thập</h3>
            <p className="policy-text">
            ...
            <h3 className="policy-subtitle">2. Cách chúng tôi sử dụng thông tin của bạn</h3>
            <p className="policy-text">
            ...
            <h3 className="policy-subtitle">3. Chia sẻ thông tin</h3>
            <p className="policy-text">
            ...
            <h3 className="policy-subtitle">4. Bảo mật</h3>
            <p className="policy-text">
            ...
            <h3 className="policy-subtitle">5. Lựa chọn của bạn</h3>
            <p className="policy-text">
            ...
            <h3 className="policy-subtitle">6. Cookie và Công nghệ theo dõi</h3>
            <p className="policy-text">
          ...
          {/* Changes to Terms */}
          <div className="policy-section" data-aos="fade-up">
            <h2 className="policy-title">THAY ĐỔI ĐIỀU KHOẢN</h2>
            <p className="policy-text">
          ...
          {/* Contact Information */}
          <div className="policy-section" data-aos="fade-up">
            <h2 className="policy-title">LIÊN HỆ CHÚNG TÔI</h2>
            <p className="policy-text">
            ...
            <p className="policy-text">Cập nhật lần cuối: Tháng 6 năm 2025</p>
          </div>
        </div>
      </section>
